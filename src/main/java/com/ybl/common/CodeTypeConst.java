...
public class CodeTypeConst {
	...
	public static final String CODE_TYPE_RANKSERIES_AGENT = "agent"; // 独立行销序列（北分）
	// 人员职级序列RankSeries_Code
	/**
	 * 销售人员职级序列
	 * CODE_TYPE_RANKSERIES_SALES= "sales"
	 */
	public static final String CODE_TYPE_RANKSERIES_SALES = "sales"; // 销售人员（北分、总版）
	/**
	 * 管理人员职级序列
	 * CODE_TYPE_RANKSERIES_MANAGER="manager"
	 */
	public static final String CODE_TYPE_RANKSERIES_MANAGER = "manager"; // 管理人员（北分、总版）
	
	public static final String CODE_TYPE_RANKSERIES_QUMANAGER = "qumanager";// 区域总监序列（总版）

	
	// 人员职位
	public static final String CODE_TYPE_POST_CODE_SALES = "sales"; // 营销员
	public static final String CODE_TYPE_POST_CODE_ZULEADER = "zuleader"; // 组主管
	public static final String CODE_TYPE_POST_CODE_QULEADER = "quleader"; // 区主管
	...
	public static final String CODE_TYPE_BUSINESS_TYPE_RECRUITBASIC="RecruitBasic";
	...
	public static final String APPROVAL_ITEM_RECRUIT_BASIC="09";
	...
	public static final String FEE_STATUS_CANCEL="2";
	...
	public static final String FEE_TYPE_NEXT="42";
	 ...
	 * 2	附险
	 */
	public static final String CODE_TYPE_INS_TYPE_MASTER = "1";
	public static final String CODE_TYPE_INS_TYPE_SUJOIN = "2";
	 ...
	 * 4 4级机构
	 */
	public static final String BRANCH_LEVEL1="1";
	public static final String BRANCH_LEVEL2="2";
	public static final String BRANCH_LEVEL3="3";
	...
	public static final String RECRUITPERSON_NORMSTAR_TRUE = "27";// 招募流程状态信息--诺姆四达通过 
	public static final String RECRUITPERSON_NORMSTAR_FALSE = "28";// 招募流程状态信息--诺姆四达不通过
	public static final String RECRUITPERSON_LEADERLESS_TRUE = "29";// 招募流程状态信息--无领导小组讨论通过
	public static final String RECRUITPERSON_LEADERLESS_FALSE = "30";// 招募流程状态信息--无领导小组讨论不通过
	public static final String RECRUITPERSON_BASIC_WAIT = "31";// 招募流程状态信息--招募人员基本信息待审批
	public static final String RECRUITPERSON_APPR_NOPASS = "32";//人员基本信息审批不通过
	...
	//学历编号：大专以下
	public static final String CODE_COLLEGE_BELOW = "12"; //学历编号：大专以下
...
/*	培训期数信息
	...
	*/
	...
	public static final String plan_periods6 = "6"; 
	public static final String plan_periods7 = "7"; 
	public static final String plan_periods8 = "8"; 
	public static final String plan_periods9 = "9"; 
	public static final String plan_periods10 = "10"; 
	public static final String plan_periods11 = "11"; 
	public static final String plan_periods12 = "12"; 
...
/*	培训方式信息
	 ...
	 * 2           无效   
	 */
	public static final String TEACHER_STATUS_EFFECTIVE = "1"; 
	public static final String TEACHER_STATUS_NOTEFFECTIVE = "2"; 
	 ...
	 * 2  外部 
	 */
	public static final String TEACHER_TYPE_FULLTIME = "0"; 
	public static final String TEACHER_TYPE_NOTFULLTIME = "1"; 
	public static final String TEACHER_TYPE_OUTSIDE = "2"; 
	...
	public static final String ATTACHMENT_UPLOAD_TOBIG = "最大附件2M";	//最大附件2M
	public static final String BIG_ATTACHMENT_UPLOAD_TOBIG = "最大附件10M";	//最大附件10M
	/**
	 * 项目附件最大上传大小 2M
	 */
	//公告------------------------------------------------start
	
	public static final int ATTACHMENT_UPLOAD_MAXSIZE = 2097152;//最大大小2M
	public static final int BIG_ATTACHMENT_UPLOAD_MAXSIZE=10485760;//最大大小10M
	 ...
	 * 	deduc_type2	税前扣款
	 */
	public static final String SAS_DEDUC_TYPE1 = "deduc_type1";//税前加款
	public static final String SAS_DEDUC_TYPE2 = "deduc_type2";//税前扣款
	 ...
	 *     2	税后
	 */
	public static final String SAS_TAX_TYPE1 = "1";//税前
	public static final String SAS_TAX_TYPE2 = "2";//税后
	 ...
	 *   Calculate
	 */
	public static final String SAS_TAX_CALCUTE = "2W";//薪酬计算
	public static final String SAS_TAX_CONFIRM="2WC";//薪酬确认
	 ...
	 *     4      计算失败
	 */
	public static final String SAS_TASK_TYPE1 = "1";//待计算
	public static final String SAS_TASK_TYPE2 = "2";//计算中
	public static final String SAS_TASK_TYPE3 = "3";//计算成功
	public static final String SAS_TASK_TYPE4 = "4";//计算失败
	 ...
	 *  	YJ	             试算
	 */
	public static final String SAS_CALCUTE_TYPE1 = "ZS";//正式计算
	public static final String SAS_CALCUTE_TYPE2 = "YJ";//试算
     ...
     * 4  专业证书
     */
  public static final String SALES_PHOTO_IMAGE="1";
  public static final String SALES_SHOW_IMAGE="2";
  public static final String SALES_ACTION_IMAGE="3";
  public static final String SALES_ABILITY_IMAGE="4";
   ...
   * 2 无效
   */
   public static final String SCAN_STATUS_AVAILABLE="1";
   public static final String SCAN_STATUS_NULLITY="2";
   ...
   public static final String IMAGE_SEND_STATUS_SUCCESS="1";
   public static final String IMAGE_SEND_STATUS_MULE_BACK="2";
   public static final String IMAGE_SEND_STATUS_BACK="3";
   ...
   public static final String PRODUCT_CHARGE_PERIOD1="1";
   public static final String PRODUCT_CHARGE_PERIOD3="3";
	 ...
	 * String
	 */
	public static final String CODE_TYPE_RATE_CONVERT = "01";
	
	/**
	 * 02   激励佣金率
	 * String
	 */
	public static final String CODE_TYPE_RATE_ENCOURAGE = "02";
	
	/**
	 * 04   总版折标率
	 * String
	 */
	public static final String CODE_TYPE_RATE_ZMGJCONVERT = "04";
	
	/**
	 * 05  佣金率
	 * String
	 */
	public static final String CODE_TYPE_RATE_FYC = "05";
	
	/**
	 * 06  总版续年度佣金率
	 * String
	 */
	public static final String CODE_TYPE_RATE_XYC = "06";
	/**
	 * 07 产品手续费率
	 * String
	 */
	public static final String CODE_TYPE_RATE_PRO = "07";
	 ...
	 * String
	 */
	public static final String CODE_RATE_STATUS_VALID = "1";
	 ...
	 * String
	 */
	public static final String CODE_RATE_STATUS_NULLITY = "0";
	 ...
	 * 
	 */
	public static final String SCAN_IMAGE_TYPE1 = "1";
	public static final String SCAN_IMAGE_TYPE2 = "2";
	public static final String SCAN_IMAGE_TYPE3 = "3";
	
	/**
	 * 手续费对账状态
	 * 6  财务已确认
	 */
	public static final String FINANCIAL_COMFIRMED = "6";
	 ...
	 * 运维附件
	 */
	public static final String SYS_Attachment_BusType = "122";
	 ...
	 * 2：代理合同
	 */
	public static final String L_CONTRACT_TYPE = "1";
	public static final String D_CONTRACT_TYPE = "2";
	 ...
	 * 生成保单id和客户id
	 */
	public static final String POLICYLIFENOCAR_SERIES_CODE="40";	
	/**
	 * 非车险关系人角色类型
	 * 1	投保人
	 * 2	被保险人
	 ...
	 * 7	联系人
	 */
	public static final String POLICYLIFENOCAR_ROLETYPE_HOLDER="1";	
	public static final String POLICYLIFENOCAR_ROLETYPE_INSURANT="2";	
	public static final String POLICYLIFENOCAR_ROLETYPE_CAROWNER="3";	
	 ...
	 * 2 公司
	 */
	public static final String POLICYLIFENOCAR_RELATIONTYPE_PERSON="1";	
	public static final String POLICYLIFENOCAR_RELATIONTYPE_COMPANY="2";	
	 ...
	 * 3              意外险
	 */
	public static final String PROPERTYCONTRACT_TYPE_CAR="1";	
	public static final String PROPERTYCONTRAC_TTYPE_NOTCAR="2";	
	public static final String PROPERTYCONTRAC_TTYPE_ECCIDENT="3";	
	
	/**
	 * 币种数据字典SYS_Library_MoneyType
	 */
	public static final String MONEYTYPE_CNY="1";
	 ...
	 * 4	附加险信息
	 */
	public static final String GUARANTEE_TYPE_ESSENTIAL="1";	
	public static final String GUARANTEE_TYPE_BUSINESS="2";	
	public static final String GUARANTEE_TYPE_BASIC="3";	
	public static final String GUARANTEE_TYPE_ADDITION="4";	
	/**
	 * 财险产品代码
	 * 4车船使用税
	 * 5 交通事故责任强制保险
	 * 6 商业保险
	 */
	public static final String CONTRACT_PRODUCT_TRAVEL="4";	
	public static final String CONTRACT_PRODUCT_TRAFFIC="5";	
	public static final String CONTRACT_PRODUCT_BUSINESS="6";	
	/**
	 * 团险投保单分担状态
	 * 1 分单上传中
	 * 2 分单上传失败
	 ...
	 * 4 投保单进入正常有效状态
	 * */
	public static final String GROUP_POLICY_UPLOAD="1";
	public static final String GROUP_POLICY_ERROR="2";
	public static final String GROUP_POLICY_WAIT="3";
	public static final String GROUP_POLICY_SUCCESS="4";
	/**
	 * 团险投保单分担状态
	 * 1 分单上传中
	 * 2 分单上传失败
	 * 3 有效
	 * */
	public static final String GROUP_CONTRACT_UPLOAD="1";
	public static final String GROUP_CONTRACT_ERROR="2";
	public static final String GROUP_CONTRACT_SUCCESS="3";
	/**
	 * 团险业务类型
	 * 21 投保单业务类型
	 * 22 保单业务类型
	 */
	public static final String GROUP_POLICY_TYPE="21";
	public static final String GROUP_CONTRACT_TYPE="22";
	 ...
	 * 4 团险
	 */
	public static final String PRODUCT_LIFE_INSURANCE = "1";
	public static final String PRODUCT_AUTO_INSURANCE = "2";
	public static final String PRODUCT_PROPERTY_INSURANCE = "3";
	public static final String PRODUCT_GROUP_INSURANCE = "4";
}
