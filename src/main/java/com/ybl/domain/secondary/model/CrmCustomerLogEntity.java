...
@Entity
@Table(name = "crm_customer_log", schema = "lifecore")
public class CrmCustomerLogEntity  implements Serializable {
    private int seqId;
    ...
    public boolean equals(Object o) {
        ...
        CrmCustomerLogEntity that = (CrmCustomerLogEntity) o;
        return seqId == that.seqId &&
                logSeqId == that.logSeqId &&
    ...
    public int hashCode() {
        ...
        return Objects.hash(seqId, customerId, customerType, name, title, gender, birthday, certiType, certiNo, certiValiddate, education, nationality, nation, homeplace, seatAddress, height, weight, political, education2, maritalStat, health, jobType, jobCode, incomeType, bankCode, bankAccountNo, bankAccountName, isTelmsgservice, status, remark, logSeqId, logBustype, logBusdate, logDate, logRemark, createuser, createdate, modifyuser, modifydate, memberId);
    }
}
